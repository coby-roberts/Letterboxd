...
function TmdbMovieCard({ movieId }) {
  ...
  return (
    // <div className="TmdbMovieCard">
    //   {movieDetails.backdrop_path && <img src={`https://image.tmdb.org/t/p/w1280/${movieDetails.backdrop_path}`} alt={movieDetails.title} />}
    ...
    // </div>
        ...
        <div className="TmdbMovieCard" style={{ fontFamily: "monospace", color: "#9AE6B4" }}>
      {/* Backdrop */}
      {/*  */}
      {backdropUrl && (
        <div style={{ position: "relative" }}>
          ...
          >
            ...
            >
              <div style={{ fontSize: "10px", color: "#68D391", marginBottom: 4 }}>
                ► STATUS: [ACTIVE]
              </div>
            ...
            >
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 4 }}>
                ...
                <div>
                  {Array.from({ length: Math.floor(movieDetails.vote_average) }).map(
                    (_, i) => (
            ...
            >
              ...
              <div style={{ fontSize: "10px", color: "#68D391", marginBottom: 2 }}>
                ► GENRES:
              </div>
      ...
      <div style={{ padding: 24 }}>
        ...
        >
          {/* Origin Country */}
          <div>
            <div style={{ color: "#68D391", marginBottom: 4 }}>► ORIGIN_COUNTRY:</div>
            <div>{movieDetails.origin_country.join(", ")}</div>
          </div>

          {/* Production Companies */}
          <div>
            <div style={{ color: "#68D391", marginBottom: 4 }}>► PRODUCTION:</div>
            <div>
